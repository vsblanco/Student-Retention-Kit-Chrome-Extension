...
export function cacheDomElements() {
    ...
    if (contactTab) {
        ...
        if (!five9Indicator) {
            ...
            five9Indicator.style.cssText = 'display:none; position:absolute; top:0; left:0; right:0; bottom:0; flex-direction:column; align-items:center; justify-content:center; background-color:rgba(255,255,255,0.98); color:#6b7280; text-align:center; padding:20px; z-index:100; backdrop-filter:blur(2px);';
